      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-3xl">
          ...
          <div className="text-center mb-8">
            <img src="/console/logo.svg" alt="OmniCore" className="mx-auto" width={120} />
          </div>
                  ...
                  {(!configStatus.root_email_configured ||
                    ...
                    <div className="mt-12">
                      {!configStatus.root_email_configured && (
                        ...
                        >
                          <Input placeholder={t`admin@example.com`} />
                        </Form.Item>
                      )}
                      {!configStatus.api_endpoint_configured && (
                        <Form.Item
                        ...
                        >
                          <Input placeholder={t`https://notifuse.example.com`} />
                        </Form.Item>
                      )}
                    </div>
                  )}
                    ...
                    <>
                      ...
                      <Row gutter={16}>
                        <Col span={10}>
                          ...
                          >
                            <Input placeholder={t`smtp.example.com`} />
                          </Form.Item>
                        </Col>
                        <Col span={8}>
                          <Form.Item
                      ...
                      <Row gutter={16}>
                        <Col span={12}>
                          <Form.Item label={t`SMTP Username`} name="smtp_username">
                            <Input placeholder={t`user@example.com`} />
                          </Form.Item>
                        </Col>
                        <Col span={12}>
                          <Form.Item label={t`SMTP Password`} name="smtp_password">
                            <Input.Password placeholder={t`••••••••`} />
                          </Form.Item>
                        </Col>
                      </Row>
                      ...
                      <Row gutter={16}>
                        <Col span={12}>
                          ...
                          >
                            <Input placeholder={t`notifications@example.com`} />
                          </Form.Item>
                        </Col>
                        <Col span={12}>
                          <Form.Item label={t`From Name`} name="smtp_from_name">
                            <Input placeholder={t`Notifuse`} />
                          </Form.Item>
                        </Col>
                      </Row>
