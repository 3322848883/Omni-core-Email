...
vi.mock('../i18n/locales/en.js', () => ({ messages: englishMessages }))
vi.mock('../i18n/locales/fr.js', () => ({ messages: frenchMessages }))
vi.mock('../i18n/locales/es.js', () => ({ messages: spanishMessages }))
vi.mock('../i18n/locales/de.js', () => ({ messages: germanMessages }))
vi.mock('../i18n/locales/ca.js', () => ({ messages: catalanMessages }))
vi.mock('../i18n/locales/pt-BR.js', () => ({ messages: portugueseBRMessages }))
vi.mock('../i18n/locales/ja.js', () => ({ messages: japaneseMessages }))
vi.mock('../i18n/locales/it.js', () => ({ messages: italianMessages }))
vi.mock('../i18n/locales/zh.js', () => ({ messages: chineseMessages }))
...
describe('i18n utility functions', () => {
  ...
  describe('getInitialLocale', () => {
    it('returns "zh" when localStorage is empty', () => {
    ...
    it('returns "zh" when stored locale is invalid', () => {
  ...
  describe('locales and localeNames', () => {
    it('exports all supported locales', () => {
      expect(locales).toEqual(['en', 'fr', 'es', 'de', 'ca', 'pt-BR', 'ja', 'it', 'zh'])
    })
...
describe('LocaleContext', () => {
  ...
  it('provides locale name for current locale', async () => {
    ...
    expect(screen.getByTestId('locale-name')).toHaveTextContent('简体中文')
  })
...
describe('Translation rendering', () => {
  ...
  it('renders Chinese translations by default', async () => {
    ...
    expect(screen.getByTestId('i18n-locale')).toHaveTextContent('zh')
  })
  ...
  it('renders translated content based on active locale', async () => {
    ...
    expect(screen.getByTestId('greeting')).toHaveTextContent('你好')
    expect(screen.getByTestId('farewell')).toHaveTextContent('再见')
