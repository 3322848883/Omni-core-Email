...
export const renderCategoryTag = (category: string, t?: (msg: string) => string) => {
  let color = 'default'
                      ...
                      >
                        <Select
                          ...
                          options={[
                            {
                              value: 'marketing',
                              label: renderCategoryTag('marketing', (msg) => t`${msg}`)
                            },
                            {
                              value: 'transactional',
                              label: renderCategoryTag('transactional', (msg) => t`${msg}`)
                            },
                            {
                              value: 'welcome',
                              label: renderCategoryTag('welcome', (msg) => t`${msg}`)
                            },
                            {
                              value: 'opt_in',
                              label: renderCategoryTag('opt_in', (msg) => t`${msg}`)
                            },
                            {
                              value: 'unsubscribe',
                              label: renderCategoryTag('unsubscribe', (msg) => t`${msg}`)
                            },
                            {
                              value: 'bounce',
                              label: renderCategoryTag('bounce', (msg) => t`${msg}`)
                            },
                            {
                              value: 'blocklist',
                              label: renderCategoryTag('blocklist', (msg) => t`${msg}`)
                            }
                          ]}
                        />
                      </Form.Item>
